...
public class AddBusinessListingActivityBackup extends BaseActivity implements View.OnClickListener, View.OnKeyListener {
...
//    ImageView gifPrice;
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddBusinessListingActivityBackup.this);
...
//        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddBusinessListingActivityBackup.this);
        ...
        switch (radioButton.getId()) {
            ...
            case R.id.rbSelect:
                if (checked) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddBusinessListingActivityBackup.this, MapsActivity.class);
