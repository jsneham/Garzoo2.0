...
public class BusinessInnerActivity extends AppCompatActivity implements SliderLayout.SliderInterface , OnDashboardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            getToolBar();
            initRecyclerView();
            getDashboardList(business.getUser_id(), "B");
            subscribeObservers();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                list.getTitle(),list.getPrice(),Utils.formateDate(list.getDt()), list.getEmp_status());
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ListingAdapter(this, context, initGlide(), viewPreloader,user_id, business.getTitle());
        ...
        rvList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if(!rvList.canScrollVertically(1)){
                    ...
                    mViewModel.searchUserMoreListNextPage(business.getUser_id(), search_name, latitude,longitude,"B");
