...
public interface BusinessApi {
    ...
    @GET(URLs.api_business_data_2_0)
    LiveData<ApiResponse<BusinessResponse>> getBusiness(
    ...
    @Multipart
    @POST(URLs.api_business_add_record)
    ...
    @Multipart
    @POST(URLs.api_business_edit_record_2_0)
    ...
    @Multipart
    @POST(URLs.api_add_listing_interest_2_0)
    LiveData<ApiResponse<BusinessResponse>> interest1(
            @Part("unique_id") RequestBody unique_id,
            @Part("user_id") RequestBody user_id,
            @Part("to_user_id") RequestBody  to_user_id,
            @Part("full_name") RequestBody  full_name,
    ...
    LiveData<ApiResponse<BusinessResponse>> Business_delete_record_2_0(
            @Query("unique_id") String unique_id,
