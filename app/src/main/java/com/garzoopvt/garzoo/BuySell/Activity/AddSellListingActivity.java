...
public class AddSellListingActivity extends BaseActivity implements View.OnClickListener, KeyboardView.OnKeyboardActionListener , View.OnKeyListener {
...
//        mKeyboardView.setOnKeyboardActionListener(this);
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddSellListingActivity.this);
        ...
        rbLocation.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.rbHome) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddSellListingActivity.this, MapsActivity.class);
...
//        }
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddSellListingActivity.this);
...
//                        Toast.makeText(this, "Permission Denied, You cannot access location data and camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AddSellListingActivity.this)
                .setMessage(message)
                .setCancelable(false)
