...
public class AddSellListingActivity extends BaseActivity implements View.OnClickListener, View.OnKeyListener {
    ...
    private void uploadImage() {
        try {
            ...
            RequestBody rb_user_id = RequestBody.create(okhttp3.MultipartBody.FORM, user_id);
            RequestBody rb_mobile_status = RequestBody.create(okhttp3.MultipartBody.FORM, mobile_status);
            RequestBody rb_category_id = RequestBody.create(okhttp3.MultipartBody.FORM, category_id);
            RequestBody title = RequestBody.create(okhttp3.MultipartBody.FORM, etTitle.getText().toString());
            RequestBody description = RequestBody.create(okhttp3.MultipartBody.FORM, etDescription.getText().toString());
            RequestBody price = RequestBody.create(okhttp3.MultipartBody.FORM, etPrice.getText().toString());
            RequestBody address = RequestBody.create(okhttp3.MultipartBody.FORM, Area + " ," + Taluka);
            RequestBody rb_Lat = RequestBody.create(okhttp3.MultipartBody.FORM, Lat);
            RequestBody rb_Long = RequestBody.create(okhttp3.MultipartBody.FORM, Long);

            Call<ResponseBody> call = mViewModel.uploadData(list, rb_user_id, rb_mobile_status, rb_category_id, title,
                    description, price, rb_Lat, rb_Long, address, videos); //.get(0)
