...
public class AddSellListingActivityBackup extends BaseActivity implements View.OnClickListener, View.OnKeyListener {
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddSellListingActivityBackup.this);
...
//        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddSellListingActivityBackup.this);
        ...
        switch (radioButton.getId()) {
            ...
            case R.id.rbSelect:
                if (checked) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddSellListingActivityBackup.this, MapsActivity.class);
