...
public class AddSellListingActivitylatestBackup extends BaseActivity implements View.OnClickListener, KeyboardView.OnKeyboardActionListener , View.OnKeyListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sell_listing);
        //setTitle("Add");
        try {
            init();
            imagelist();
    ...
    private void disableCopyPaste() {
        ...
        etDescription.setLongClickable(false);
...
//        etDescription.setOnKeyListener(this);
//        etPrice.setOnKeyListener(this);
//        tvArea.setOnKeyListener(this);
//        tvTaluka.setOnKeyListener(this);
...
//        mCustomKeyboard = new EditCustomKeyboard(AddSellListingActivity.this, R.id.keyboardview, R.xml.numeric);
//        mKeyboardView = (KeyboardView) findViewById(R.id.keyboardview);
//        mKeyboardView.setKeyboard(new Keyboard(AddSellListingActivity.this, R.xml.numeric));
...
//        mKeyboardView.setOnKeyboardActionListener(this);
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddSellListingActivitylatestBackup.this);
    ...
    private void getToolBar() {
        ...
        actionBar.setTitle(R.string.add_sell);
        ...
        rbLocation.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.rbHome) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddSellListingActivitylatestBackup.this, MapsActivity.class);
...
//        else if(LocationSelectionMode==3){
...
//            }
//        }
//        else if(LocationSelectionMode==2) {
...
//        }
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddSellListingActivitylatestBackup.this);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        ...
        if (focusCurrent == null || focusCurrent.getClass() != AppCompatEditText.class) return false;
...
//                        Toast.makeText(this, "Permission Denied, You cannot access location data and camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AddSellListingActivitylatestBackup.this)
                .setMessage(message)
                .setCancelable(false)
    ...
    private class uplaodDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                final String URL = URLs.api_sell_add_record;
