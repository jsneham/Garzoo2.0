...
public class DbEditSellListingActivity extends BaseActivity implements View.OnClickListener, View.OnKeyListener {

    private String TAG = "EditSellListingActivity";
    ...
    private void uploadImage() {
        try {
            ...
            Call<ResponseBody> call = mViewModel.editData(list, rb_user_id, rb_mobile_status, rb_category_id, title,
                    description, price, rb_Lat, rb_Long, address, videos,p); //.get(0)
