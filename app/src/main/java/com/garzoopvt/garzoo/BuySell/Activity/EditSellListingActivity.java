...
public class EditSellListingActivity extends BaseActivity implements View.OnClickListener, KeyboardView.OnKeyboardActionListener {
...
//        Taluka=sessionManager.getFromSessionManager(SessionManager.TALUKA_List);
        ...
        rbLocation.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.rbHome) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(EditSellListingActivity.this, MapsActivity.class);
    ...
    private void setData() {
        ...
        tvCategoryName.setText(productArrayList.getCategory());
...
//        mCustomKeyboard = new EditCustomKeyboard(EditSellListingActivity.this, R.id.keyboardview, R.xml.numeric);
//        mKeyboardView = (KeyboardView) findViewById(R.id.keyboardview);
//        mKeyboardView.setKeyboard(new Keyboard(EditSellListingActivity.this, R.xml.numeric));
...
//        mKeyboardView.setOnKeyboardActionListener(this);
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, EditSellListingActivity.this);
...
//                flat_images.add(ImagePath);
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(EditSellListingActivity.this);
    ...
    private void uploadData(final String name, final String address) {
        ...
        if(removeImageList.size()>0){
            for(int i=0; i<removeImageList.size();i++){
                deleteImage(removeImageList.get(i).getImage_id(), removeImageList.get(i).getPath(), productArrayList.getId());
            }
...
//                        Toast.makeText(this, "Permission Denied, You cannot access location data and camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(EditSellListingActivity.this)
                .setMessage(message)
                .setCancelable(false)
    ...
    private void deleteImage(String delete_image_id, String delete_path,String post_id) {
        Call<ResponseBody> call=  mViewModel.deleteImage(delete_image_id, delete_path,post_id);
                    ...
                    if (response.isSuccessful()) {
                        try {
                            for(int i=0; i<imageList.size();i++){
                                mViewModel.updateImage(imageList.get(i).getImage_id(), imageList.get(i).getPath(), productArrayList.getId(), "buy");
                            }
    ...
    private class uplaodDataToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                final String URL = URLs.api_edit_record_2_0;
