...
public class BuySubCategoryAdapter extends RecyclerView.Adapter<BuySubCategoryAdapter.MyViewHolder> {
...
//        }
    ...
    public BuySubCategoryAdapter(Context context, OnCategoryListener onCategoryListener) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.buy_sub_categories_row, parent, false);
