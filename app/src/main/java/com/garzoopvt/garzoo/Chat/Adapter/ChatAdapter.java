...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChatAdapter(Context context, String user_id, OnItemListener onItemListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            case LIST_TYPE: {
                view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.chat_row, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        try {
            ...
            switch (viewType) {
                case LIST_TYPE:
                    ChatUser chat = (ChatUser) userArrayList.get(position);
...
//                    viewHolder.count.setVisibility(View.GONE);
    ...
    public void setQueryExhausted() {
        hideLoading();
        ChatUser exhaustedRecipe = new ChatUser();
    ...
    public ChatUser getSelected(int position) {
        if (userArrayList != null) {
            if (userArrayList.size() > 0) {
