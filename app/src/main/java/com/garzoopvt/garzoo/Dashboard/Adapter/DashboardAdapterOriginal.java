...
public class DashboardAdapterOriginal extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public DashboardAdapterOriginal(OnDashboardListener mOnDashboardListener, Context mContext,
