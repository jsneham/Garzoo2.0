...
@Entity(tableName = "dashboardlists")
public class DashboardList implements Parcelable {
    ...
    public DashboardList(@NonNull String id, String admin_id, String category_id, String user_id, String title, String description,
    ...
    @Ignore
    public DashboardList(DashboardList dashboardList){
        this.id = dashboardList.id;
        this.admin_id = dashboardList.admin_id;
        this.category_id = dashboardList.category_id;
        this.user_id = dashboardList.user_id;
        this.title = dashboardList.title;
        this.description = dashboardList.description;
        this.price = dashboardList.price;
        this.image = dashboardList.image;
        this.latitude = dashboardList.latitude;
        this.longitude = dashboardList.longitude;
        this.status = dashboardList.status;
        this.last_modified = dashboardList.last_modified;
        this.dt = dashboardList.dt;
        this.fname = dashboardList.fname;
        this.lname = dashboardList.lname;
        this.category = dashboardList.category;
        this.data_type = dashboardList.data_type;
        this.listing_status = dashboardList.listing_status;
        this.address = dashboardList.address;
        this.available_status = dashboardList.available_status;
        this.mobile =dashboardList. mobile;
        this.images = dashboardList.images;
        this.distance = dashboardList.distance;
        this.interest_status = dashboardList.interest_status;
        this.mobile_status = dashboardList.mobile_status;
        this.video = dashboardList.video;
        this.media_url = dashboardList.media_url;
        this.area = dashboardList.area;
        this.taluka = dashboardList.taluka;
        this.pd_status = dashboardList.pd_status;
    ...
    protected DashboardList(Parcel in) {
        id = in.readString();
    ...
    public static final Creator<DashboardList> CREATOR = new Creator<DashboardList>() {
        @Override
        public DashboardList createFromParcel(Parcel in) {
            return new DashboardList(in);
        }

        @Override
        public DashboardList[] newArray(int size) {
            return new DashboardList[size];
        }
    };
