...
public class AddEmpRegisterListingActivity extends BaseActivity implements View.OnClickListener, KeyboardView.OnKeyboardActionListener {
...
//        mCustomKeyboard = new EditCustomKeyboard(AddEmpRegisterListingActivity.this, R.id.keyboardview, R.xml.numeric);
//        mKeyboardView = (KeyboardView) findViewById(R.id.keyboardview);
//        mKeyboardView.setKeyboard(new Keyboard(AddEmpRegisterListingActivity.this, R.xml.numeric));
...
//                        Toast.makeText(this, "Permission Denied, You cannot access camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AddEmpRegisterListingActivity.this)
                .setMessage(message)
                .setCancelable(false)
    ...
    private class uplaodDataToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                multipartUtility.addFormField("emp_status", "2");
