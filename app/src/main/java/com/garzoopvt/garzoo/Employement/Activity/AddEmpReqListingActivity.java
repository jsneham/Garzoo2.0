...
public class AddEmpReqListingActivity extends BaseActivity implements View.OnClickListener, KeyboardView.OnKeyboardActionListener {
...
//        mCustomKeyboard = new EditCustomKeyboard(AddEmpReqListingActivity.this, R.id.keyboardview, R.xml.numeric);
//        mKeyboardView = (KeyboardView) findViewById(R.id.keyboardview);
//        mKeyboardView.setKeyboard(new Keyboard(AddEmpReqListingActivity.this, R.xml.numeric));
...
//        mKeyboardView.setOnKeyboardActionListener(this);
    ...
    private void init() {
        ...
        // filterCategoryArrayList = (ArrayList<FilterCategory>) getIntent().getSerializableExtra("data");
...
//                    if(event.getRawX() >= (etDescription.getRight() - etDescription.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
...
//                if(event.getAction() == MotionEvent.ACTION_UP) {
////                    if(event.getRawX() <= (etDescription.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())){
//                    if(event.getRawX() >= (etPrice.getRight() - etPrice.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
//                        startVoiceInput("etPrice");
//                        return true;
//                    }
//                }
//                return false;
...
//
        ...
        ivImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (requestCamera && images.size() < image_count) {
                    ...
                    openSnackBar(context.getString(R.string.image_error));
                }
        ...
        ivVdeo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (requestCamera && videoList.size() < 1) {
    ...
    private boolean Validation() {
        if (TextUtils.isEmpty(etTitle.getText().toString()) || etTitle.getText().toString().trim().equals("")) {
            etTitle.setError(getString(R.string.err_emp_title));
            etTitle.requestFocus();
            return false;
        } else if (TextUtils.isEmpty(etDescription.getText().toString()) || etDescription.getText().toString().trim().equals("")) {
            etDescription.setError(getString(R.string.err_emp_descr));
...
//                        Toast.makeText(this, "Permission Denied, You cannot access location data and camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(AddEmpReqListingActivity.this)
                .setMessage(message)
                .setCancelable(false)
    ...
    private class uplaodDataToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                final String URL = URLs.api_emp_add_record;
                ...
                multipartUtility.addFormField("emp_status", "1");
