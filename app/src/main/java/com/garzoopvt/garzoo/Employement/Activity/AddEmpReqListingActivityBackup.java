...
public class AddEmpReqListingActivityBackup extends BaseActivity implements View.OnClickListener, View.OnKeyListener {
...
//    TextView etCategory;
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddEmpReqListingActivityBackup.this);
...
//        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddEmpReqListingActivityBackup.this);
        ...
        switch (radioButton.getId()) {
            ...
            case R.id.rbSelect:
                if (checked) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddEmpReqListingActivityBackup.this, MapsActivity.class);
