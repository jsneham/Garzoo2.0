...
public class DbEditEmpListingActivity extends BaseActivity implements View.OnClickListener , KeyboardView.OnKeyboardActionListener {
...
//        mCustomKeyboard = new EditCustomKeyboard(DbEditEmpListingActivity.this, R.id.keyboardview, R.xml.numeric);
//        mKeyboardView = (KeyboardView) findViewById(R.id.keyboardview);
//        mKeyboardView.setKeyboard(new Keyboard(DbEditEmpListingActivity.this, R.xml.numeric));
...
//        mKeyboardView.setOnKeyboardActionListener(this);
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, DbEditEmpListingActivity.this);
        ...
        rbLocation.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if (checkedId == R.id.rbHome) {
                    ...
                    tvArea.setText("");
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(DbEditEmpListingActivity.this, MapsActivity.class);
...
//        }
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(DbEditEmpListingActivity.this);
...
//                        Toast.makeText(this, "Permission Denied, You cannot access camera.", Toast.LENGTH_LONG).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(DbEditEmpListingActivity.this)
                .setMessage(message)
                .setCancelable(false)
