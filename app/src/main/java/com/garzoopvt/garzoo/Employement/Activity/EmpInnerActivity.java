...
public class EmpInnerActivity extends AppCompatActivity implements SliderLayout.SliderInterface , OnDashboardListener {
    ...
    private TextView tvTitle,tvDescription,tvCategory,tvPrice,type,tvName,tvMore;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_inner);
            ...
            getToolBar();
            initRecyclerView();
            getDashboardList(employment.getUser_id(), "E");
            subscribeObservers();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//        else action_edit.setVisible(false);
    ...
    public void onSliderClicked(int idx) {
        String image_path = imageVideo[idx - 1];
...
//        logActivity(id, to_user_id, user_id, "2");
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ListingAdapter(this, context, initGlide(), viewPreloader,user_id, employment.getTitle());
        ...
        rvList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if(!rvList.canScrollVertically(1)){
                    ...
                    mViewModel.searchUserMoreListNextPage(employment.getUser_id(), search_name, latitude,longitude,"E");
