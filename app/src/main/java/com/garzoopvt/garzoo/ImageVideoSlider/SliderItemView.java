...
public class SliderItemView extends RelativeLayout {
    ...
    //@(#) STATIC ATTRIBUTES SliderItemView.class.getSimpleName();
    private static final String TAG = "SliderItemView";
...
//    }
     ...
     * @param type File type (image or video)
     */
    public void setItem (String file, int type) {
        this.file = file;
        this.fileType = type;
...
//    }
    ...
    public void setOnClick (String file, int type) {
