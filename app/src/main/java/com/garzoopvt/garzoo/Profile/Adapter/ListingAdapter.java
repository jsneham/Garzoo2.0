...
public class ListingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ListingAdapter(OnDashboardListener mOnDashboardListener, Context mContext,
                          RequestManager requestManager, ViewPreloadSizeProvider<String> preloadSizeProvider, String user_id, String title) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        try {
            ...
            if(itemViewType == LIST_TYPE) {
                ...
                if(mDashboardList.get(i).getTitle().equals(title)) {
//                    mDashboardList.remove(i);
                    ...
                    ((DashboardViewHolder) viewHolder).item_container.setVisibility(View.VISIBLE);
