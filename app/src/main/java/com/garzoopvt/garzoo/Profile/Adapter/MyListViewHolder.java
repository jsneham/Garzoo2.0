...
public class MyListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    OnMyListListener mOnDashboardListener;
   public ImageView ivEdit, ivCall;
    ...
    Button ivShare, ivEditList, ivChat;
   ...
   public MaterialCardView item_container;
    ...
    public MyListViewHolder(@NonNull View itemView, OnMyListListener mOnDashboardListener, RequestManager requestManager, ViewPreloadSizeProvider<String> preloadSizeProvider) {
        super(itemView);
        ...
        params = new LinearLayout.LayoutParams(0, 0);
        ivEditList = itemView.findViewById(R.id.ivEditList);
...
//        image = itemView.findViewById(R.id.image);
        ...
        ivEditList.setOnClickListener(this::onClick);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ivChat:
                mOnDashboardListener.onDeleteClick(getAdapterPosition());
                break;

            case R.id.ivEditList:
                mOnDashboardListener.onEditClick(getAdapterPosition());
                break;
            case R.id.ivShare:
                mOnDashboardListener.onRenewClick(getAdapterPosition());
                break;
