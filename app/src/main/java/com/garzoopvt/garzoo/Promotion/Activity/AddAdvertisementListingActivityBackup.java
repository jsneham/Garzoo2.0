...
public class AddAdvertisementListingActivityBackup extends BaseActivity implements View.OnClickListener, View.OnKeyListener {

    private String TAG = "AddAdvertisementListingActivity";
...
//    ImageView gifPrice;
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddAdvertisementListingActivityBackup.this);
...
//            for (String uri : flat_images) {
            ...
            Call<ResponseBody> call = mViewModel.uploadData(list, rb_user_id, rb_mobile_status,  title,
                    description,  rb_Lat, rb_Long, address, videos,rb_pd_status); //.get(0)
...
//        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddAdvertisementListingActivityBackup.this);
        ...
        switch (radioButton.getId()) {
            ...
            case R.id.rbSelect:
                if (checked) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddAdvertisementListingActivityBackup.this, MapsActivity.class);
