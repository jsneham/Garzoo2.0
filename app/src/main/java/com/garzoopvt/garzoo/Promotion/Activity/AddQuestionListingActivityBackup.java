...
public class AddQuestionListingActivityBackup extends BaseActivity implements View.OnClickListener, View.OnKeyListener {

    private String TAG = "AddQuestionListingActivity";
    ...
    private void imagelist() {
        ...
        adapter = new ImageListAdapter(this, imageList, AddQuestionListingActivityBackup.this);
...
//        intent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, Locale.getDefault());
    ...
    public void actionDialogBox(final Context context) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddQuestionListingActivityBackup.this);
        ...
        switch (radioButton.getId()) {
            ...
            case R.id.rbSelect:
                if (checked) {
                    ...
                    llHomeAddress.setVisibility(View.GONE);
                    llAddress.setVisibility(View.VISIBLE);
                    Intent in = new Intent(AddQuestionListingActivityBackup.this, MapsActivity.class);
