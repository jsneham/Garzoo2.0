...
public class PDInnerActivity extends AppCompatActivity implements SliderLayout.SliderInterface , OnDashboardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            getToolBar();
            initRecyclerView();
            getDashboardList(pdData.getUser_id(), "P");
            subscribeObservers();
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//                rb_full_name, rb_listing_id, rb_type, rb_listing_title,rb_type);
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new ListingAdapter(this, context, initGlide(), viewPreloader,user_id, pdData.getTitle());
        ...
        rvList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if(!rvList.canScrollVertically(1)){
                    ...
                    mViewModel.searchUserMoreListNextPage(pdData.getUser_id(), search_name, latitude,longitude,"P");
