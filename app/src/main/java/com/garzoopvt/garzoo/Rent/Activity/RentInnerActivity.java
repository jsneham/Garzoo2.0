...
public class RentInnerActivity extends AppCompatActivity implements SliderLayout.SliderInterface , OnDashboardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            getToolBar();
            initRecyclerView();
            getDashboardList(productArrayList.getUser_id(), "R");
            subscribeObservers();
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        rvList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if(!rvList.canScrollVertically(1)){
                    ...
                    mViewModel.searchUserMoreListNextPage(productArrayList.getUser_id(), search_name, latitude,longitude,"R");
