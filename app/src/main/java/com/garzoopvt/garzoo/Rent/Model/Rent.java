package com.garzoopvt.garzoo.Rent.Model;
...
public class Rent implements Parcelable{
    ...
    public Rent(@NonNull String id, String admin_id, String category_id, String user_id, String title, String description,
